...
and once for all packages. You may want to parse its JSON output using
...
// packages - returns a slice of package import
// paths corresponding to slice of package patterns
