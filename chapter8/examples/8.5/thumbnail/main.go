...
func makeThumbnails5(filenames []string) (thumbfils []string, err error) {
	type item struct {
		thumbfile string
		err       error
	}
	...
	for range filenames {
		...
		thumbfils = append(thumbfils, it.thumbfile)
	}

	return thumbfils, nil
}
...
func makeThumbnails6(filenames <-chan string) int64 {
	...
	var wg sync.WaitGroup // number of working goroutins
