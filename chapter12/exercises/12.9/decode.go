/*
Extend sexpr.Unmarshal to handle the booleans, floating-point numbers,
and interfaces encoded by your solution to Exercise 12.3.
(Hint: to decode interfaces, you will need a mapping
from the name of each supported type to its reflect.Type.)
*/
...
func (d *Decoder) Token() (Token, error) {
	...
	case scanner.String:
		...
		// assumed all strings are quoted
