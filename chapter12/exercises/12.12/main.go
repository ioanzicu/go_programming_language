...
example, a string might need to be a valid email address or credit-card number, and an integer
might need to be a valid US ZIP code. Modify Unpack to check these requirements.
*/
...
func search(resp http.ResponseWriter, req *http.Request) {
	...
	if err := Unpack(req, &data, checks); err != nil {
